...
private:
    ...
    void drawFrame() {
        ...
        // Only reset the fence if we are submitting work, or possibly deadlock
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, particleGraphicsPipelineLayout, 0, 1, &particleDescriptorSets[currentFrame], 0, nullptr);
    ...
    void createParticleGraphicsPipeline() {
        auto vertShaderCode = readFile("shaders/p_vert.spv");
        auto fragShaderCode = readFile("shaders/p_frag.spv");
    ...
    bool check_extension_glfw(const char** glfwExtensions, const uint32_t  glfwExtensionCount, const uint32_t extensionCount, const std::vector<VkExtensionProperties>& extensions) {
        bool ret = true;
